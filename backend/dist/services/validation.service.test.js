...
describe("ValidationService", () => {
    it("should validate and clean raw lead payloads", () => {
        ...
        const { lead, warnings, errors } = validation_service_1.ValidationService.validateAndCleanLead(rawLead);
        ...
        expect(lead.hallucinated_field).toBeUndefined(); // Hallucination stripped
    });
    it("should detect invalid email structures", () => {
        ...
        const { lead, warnings } = validation_service_1.ValidationService.validateAndCleanLead(invalidEmailLead);
